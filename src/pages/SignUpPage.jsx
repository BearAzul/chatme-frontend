...
const SignUpPage = () => {
  ...
  const validateForm = () => {
    if (!formData.fullName.trim()) return toast.error("Nama Lengkap harus diisi")
      ...
      <div className="flex flex-col justify-center items-center px-6 py-12">
        ...
        <div className="w-full max-w-md space-y-8">
          ...
          <div className="text-center">
            <p className="text-base-content/60">Sudah punya akun?
              <Link to="/login" className="link link-primary pl-3">Login</Link>
            </p>
          </div>
        </div>
      </div>
