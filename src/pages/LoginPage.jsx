...
import { MessageSquare, Mail, Lock, Loader, Eye, EyeOff } from "lucide-react"
        ...
        <div className="w-full max-w-md space-y-8">
          <div className="text-center mb-8">
            <div className="flex flex-col items-center gap-2 group">
              ...
              <h1 className="text-2xl font-bold mt-2">Selamat Datang Kembali</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button type="submit" className="btn btn-primary w-full mt-3" disabled={isLoggingIn}>
              {isLoggingIn ? (
                <>
          ...
          <div className="text-center">
            <p className="text-base-content/60">Belum punya akun?
              <Link to="/signup" className="link link-primary pl-3">Sign Up</Link>
            </p>
          </div>
        </div>
      </div>
